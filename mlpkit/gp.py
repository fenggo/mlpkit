...
The composite kernel used throughout mlpkit is:
...
def _build_kernel(n_features: int) -> gpytorch.kernels.Kernel:
    """Build the gpytorch equivalent of the mlpkit composite kernel.
...
class GPyTorchRegressor:
    ...
    with the same public API surface used by mlpkit.
